        ...
        <form action="" method="GET" class="flex justify-between">
            <div class="flex w-7/12 justify-between">
                <div class="flex flex-col mx-3">
                    <select name="sale" class="border-0">
                ...
                <div class="flex flex-col mx-3">
                    <select name="type" class="border-0">
                ...
                <div class="py-3 self-center border-gray-500 border-2"></div>
                <div class="flex flex-col mx-3">
                    <select name="price" class="border-0">
                ...
                <div class="py-3 self-center border-gray-500 border-2"></div>
                <div class="flex flex-col mx-3">
                    <select name="bedrooms" class="border-0">
        ...
        <div class="flex flex-wrap -mx-3 justify-between mt-10">
            @foreach ($latest_properties as $property)
                <div class="flex-1 mx-2 shadow-lg relative rounded-md mb-6">
                    <a href=""
                        class="absolute left-3 w-9 h-9 leading-10 self-center top-3 bg-black text-white bg-opacity-25 text-center hover:bg-yellow-500 hover:text-white duration-200 rounded-full text-base"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="p-3">
                        ...
                        <div class="border-t-2">
                            <ul class="flex items-center -mx-1 my-4">
                                ...
                                <li class="px-2 py-1 bg-blue-50 rounded-md text-xs mx-1 shadow-sm">{{ $property->net_sqm }} ft<sup>2</sup>
                                </li>
                            </ul>
